  ...
  return (
    <section className="flex justify-center items-center h-[50vh] max-sm:h-0 max-sm:mt-40 text-white">
      <div className="flex flex-col justify-center items-center">
        ...
        >
          <h1 className="mr-1 max-sm:text-base">BERMINAT </h1>
          <div>
            <div className="mt-[8px] max-sm:mt-[4px] max-sm:text-base">
        ...
        <motion.div
          ...
          hover:bg-[#FDB13E] transition-all duration-300 max-sm:text-[10px] max-sm:py-[10px] max-sm:px-[25px] max-sm:rounded-lg
          max-2xl:text-xl"
